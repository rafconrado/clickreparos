...
// Importe os estilos do arquivo style.ts do RegisterProvider
import {
  Container,
  Header,
  HeaderContent,
...
// Defina a navegação para o próximo passo do cadastro do prestador
...
const RegisterProvider = () => {
  ...
  const handleRegister = () => {
    ...
    // Navega para o passo 2 do cadastro de prestador
